...
class AuthProvider extends ChangeNotifier {
  ...
  final GoogleSignIn _googleSignIn = GoogleSignIn(clientId: kIsWeb ? '203910149992-adtsng9s8b4nvutjp2dsterje345tgmb.apps.googleusercontent.com' : null,);
  ...
  /// Selalu ambil user terbaru dari FirebaseAuth (setelah reload())
  User?      get freshCurrentUser => _auth.currentUser;
...
// ─── Login dengan Email & Password ───────────────────────
  Future<bool> loginWithEmail({
    ...
    try {
      ...
      // ⚠️ PENTING: Reload user dari server Firebase untuk mendapatkan
      // status emailVerified yang fresh (bukan cache lokal).
      // Tanpa ini, emailVerified bisa false meskipun sudah diverifikasi.
      await _firebaseUser?.reload();
      _firebaseUser = _auth.currentUser; // Re-fetch user setelah reload
